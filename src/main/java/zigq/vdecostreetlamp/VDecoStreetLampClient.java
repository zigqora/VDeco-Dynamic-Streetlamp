...
public class VDecoStreetLampClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TRAFFIC_SIGNAL, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TRAFFIC_SIGNAL_HORIZONTAL, RenderLayer.getTranslucent());
	}
}
